...
class TestAllGood(object):
    ...
    GOOD_PAIRS = [
        ...
        ("\\begin{pmatrix}1\\\\2\\\\3\\end{pmatrix};\\begin{pmatrix}4\\\\3\\\\1\\end{pmatrix}", sympy.Tuple(Matrix([1, 2, 3]), Matrix([4, 3, 1]))),
        ("\\begin{pmatrix}1\\\\2\\\\3\\end{pmatrix};\\begin{pmatrix}4\\\\3\\\\1\\end{pmatrix}", sympy.Tuple(Matrix([1, 2, 3]), Matrix([4, 3, 1]))),
        ("\\begin{pmatrix}1\\\\2\\\\3\\end{pmatrix};\\begin{pmatrix}4\\\\3\\\\1\\end{pmatrix}", sympy.Tuple(Matrix([1, 2, 3]), Matrix([4, 3, 1]))),
        ("\\begin{pmatrix}1\\\\2\\\\3\\end{pmatrix};\\begin{pmatrix}4\\\\3\\\\1\\end{pmatrix};\\begin{pmatrix}1\\\\1\\\\1\\end{pmatrix}", sympy.Tuple(Matrix([1, 2, 3]), Matrix([4, 3, 1]), Matrix([1, 1, 1]))),
